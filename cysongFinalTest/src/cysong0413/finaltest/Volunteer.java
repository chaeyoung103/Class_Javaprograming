...
public class Volunteer {
	...
	public String toString() {
		...
		//새로구현
		Collections.sort(member,(o1,o2)->(o1.totalDonationTime-o2.totalDonationTime)*-1);
		
		for(int i =0;i<member.size();i++) {
			str += "회원 이름  : "+ member.get(i).name+"\n";
			str += "성별 : "+ member.get(i).gender+"\n";
			str += "나이 : "+ member.get(i).age+"\n";
			str += "자원봉사 참여시간 : "+ member.get(i).totalDonationTime+"\n";
